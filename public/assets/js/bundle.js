...
document.addEventListener('click', function (_ref) {
  ...
  if (target.classList.contains('logar') || target.classList.contains('cadastrar')) {
    var tela = document.querySelector(".".concat(target.classList, "-usuario"));
